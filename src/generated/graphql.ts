...
export type ResolversUnionTypes<_RefType extends Record<string, unknown>> = ResolversObject<{
  ...
  LikeableUnion: ( ActivityReply ) | ( ListActivity ) | ( MessageActivity ) | ( TextActivity ) | ( Thread ) | ( ThreadComment );
  NotificationUnion: ( Omit<ActivityLikeNotification, 'activity'> & { activity?: Maybe<_RefType['ActivityUnion']> } ) | ( Omit<ActivityMentionNotification, 'activity'> & { activity?: Maybe<_RefType['ActivityUnion']> } ) | ( ActivityMessageNotification ) | ( Omit<ActivityReplyLikeNotification, 'activity'> & { activity?: Maybe<_RefType['ActivityUnion']> } ) | ( Omit<ActivityReplyNotification, 'activity'> & { activity?: Maybe<_RefType['ActivityUnion']> } ) | ( Omit<ActivityReplySubscribedNotification, 'activity'> & { activity?: Maybe<_RefType['ActivityUnion']> } ) | ( AiringNotification ) | ( FollowingNotification ) | ( MediaDataChangeNotification ) | ( MediaDeletionNotification ) | ( MediaMergeNotification ) | ( RelatedMediaAdditionNotification ) | ( ThreadCommentLikeNotification ) | ( ThreadCommentMentionNotification ) | ( ThreadCommentReplyNotification ) | ( ThreadCommentSubscribedNotification ) | ( ThreadLikeNotification );
}>;
